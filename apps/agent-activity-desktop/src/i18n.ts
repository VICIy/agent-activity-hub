...
const dict = {
  en: {
    ...
    "adapters.restartRequired": "Hook updated. Restart {provider} to load the new configuration.",
    ...
    "esp32.title": "ESP32 device",
    "esp32.sub": "Connect an ESP32-C3 traffic light over USB. Agent state and the LED mapping are synchronized automatically.",
    "esp32.noPorts": "No serial ports found",
    "esp32.refresh": "Refresh ports",
    "esp32.connect": "Connect",
    "esp32.disconnect": "Disconnect",
    "esp32.connected": "Connected to {port}",
    "esp32.disconnected": "Not connected",
  },
  zh: {
    "brand.name": "Agent 活动",
    "brand.tag": "主控台",
    ...
    "adapters.restartRequired": "Hook 已更新，请重启 {provider} 以加载新配置。",
    ...
    "esp32.title": "ESP32 设备",
    "esp32.sub": "通过 USB 连接 ESP32-C3 红绿灯，Agent 状态与上方灯效配置会自动同步。",
    "esp32.noPorts": "未发现串口",
    "esp32.refresh": "刷新端口",
    "esp32.connect": "连接",
    "esp32.disconnect": "断开",
    "esp32.connected": "已连接 {port}",
    "esp32.disconnected": "未连接",
  },
} as const;
