...
> **文档定位：历史规划基线。** 本文保留项目最初的完整目标和阶段拆分，其中部分能力
> （例如桌面端 BLE、Effective Work 控制面和自动更新）尚未实现，不能作为当前功能清单。
> 当前架构与已交付范围请以 [`docs/architecture-cn.md`](docs/architecture-cn.md) 和
> [`docs/implementation-status.md`](docs/implementation-status.md) 为准。
>
